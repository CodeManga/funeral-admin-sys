...
public class RingProgressIndicator extends ProgressCircleIndicator {
    ...
    final String style;
    public RingProgressIndicator(final String style) {
        this.style = style;
        this.getStylesheets().add(RingProgressIndicator.class.getResource("/com/funeralapp/main/css/ringprogress.css").toExternalForm());
        this.getStyleClass().add("ringindicator");
    }

    @Override
    protected Skin<?> createDefaultSkin() {
        return new RingProgressIndicatorSkin(this, this.style);
    }
