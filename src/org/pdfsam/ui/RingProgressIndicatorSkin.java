...
public class RingProgressIndicatorSkin implements Skin<RingProgressIndicator> {
    ...
    public RingProgressIndicatorSkin(final RingProgressIndicator indicator, final String style) {
        this.indicator = indicator;
        initContainer(indicator, style);
        initFillerArc();
    ...
    private void initContainer(final RingProgressIndicator indicator, final String style) {
        container.getStylesheets().addAll(indicator.getStylesheets());
        container.getStyleClass().addAll("circleindicator-container");
        container.getStyleClass().addAll(style);
